"""
Importer Module - Multiscorer

Author: StKyr

Link: https://github.com/StKyr/multiscorer/

This module enable to pass multiple scoring parameters to sklearn cross-val_score function
